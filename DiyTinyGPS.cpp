...
// Parse a string in the form ddmm.mmmmmmm...
//modified from original Stefan
unsigned long TinyGPS::parse_degrees2()
{
  char *p;
  unsigned long left_of_decimal = gpsatol(_term);
  unsigned long hundred1000ths_of_minute = (left_of_decimal % 100UL) * 100000UL;
  ...
  return (left_of_decimal / 100) * 1000000 + hundred1000ths_of_minute/10;
}
...
bool TinyGPS::term_complete()
{
    ...
    if (checksum == _parity)
    {
      if (_gps_data_good)
      {
        ...
        case _GPS_SENTENCE_GPRMC:
		  ...
		  _latitude2  = _new_latitude2; //Stefan
          _longitude = _new_longitude;
		  _longitude2 = _new_longitude2; //Stefan
          _speed     = _new_speed;
          _course    = _new_course;
          break;
    ...
    switch(COMBINE(_sentence_type, _term_number))
  {
    ...
    case COMBINE(_GPS_SENTENCE_GPGGA, 2):
	  ...
	  _new_latitude2 = parse_degrees2(); //Stefan
    ...
    case COMBINE(_GPS_SENTENCE_GPGGA, 3):
      if (_term[0] == 'S')
        ...
        _new_latitude2 = -_new_latitude2;
        }
      break;
    case COMBINE(_GPS_SENTENCE_GPRMC, 5): // Longitude
    case COMBINE(_GPS_SENTENCE_GPGGA, 4):
      _new_longitude = parse_degrees();
	  _new_longitude2 = parse_degrees2();//Stefan
      break;
    ...
    case COMBINE(_GPS_SENTENCE_GPGGA, 5):
      if (_term[0] == 'W')
        ...
        _new_longitude2 = -_new_longitude2;
        }
      break;
...
// lat/long in MILLIONTHs of a degree and age of fix in milliseconds                            modified
// (note: versions 12 and earlier gave this value in 100,000ths of a degree.                    Stefan
void TinyGPS::get_position2(long *latitude, long *longitude, unsigned long *fix_age)
{
  if (latitude) *latitude = _latitude2;
  if (longitude) *longitude = _longitude2;
  if (fix_age) *fix_age = _last_position_fix == GPS_INVALID_FIX_TIME ? 
   GPS_INVALID_AGE : millis() - _last_position_fix;
}
