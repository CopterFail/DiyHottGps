...
public:
  ...
  void get_position2(long *latitude, long *longitude, unsigned long *fix_age = 0); //Stefan
...
private:
  ...
  long _latitude, _new_latitude, _latitude2, _new_latitude2;
  long _longitude, _new_longitude, _longitude2, _new_longitude2;
